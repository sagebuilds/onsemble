...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    meta: [
      ...
      { title: "Onsemble — Watch together, from anywhere" },
      {
        name: "description",
        content:
          "Virtual rooms with live video chat and synced streaming playback for long-distance friends.",
      },
      { name: "author", content: "Onsemble" },
